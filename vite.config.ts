...
export default defineConfig({
	...
	fmt: {
		...
		sortImports: {
			...
			customGroups: [
				{
					groupName: 'altstack/api',
					elementNamePattern: ['@altstack/api', '@altstack/api/**'],
				},
				{
					groupName: 'altstack/auth',
					elementNamePattern: ['@altstack/auth', '@altstack/auth/**'],
				},
				{
					groupName: 'altstack/db',
					elementNamePattern: ['@altstack/db', '@altstack/db/**'],
				},
				{
					groupName: 'altstack/env',
					elementNamePattern: ['@altstack/env', '@altstack/env/**'],
				},
				{
					groupName: 'altstack/shared',
					elementNamePattern: ['@altstack/shared', '@altstack/shared/**'],
				},
				{
					groupName: 'altstack/ui',
					elementNamePattern: ['@altstack/ui', '@altstack/ui/**'],
				},
				{
